...
- [ ] 04-01-PLAN.md — DATA-01: migration framework — archive orphaned 003/004 files, `apply_migrations.sh` diff-and-apply runner, `schema_migrations` fresh-bootstrap seeding (D-01..D-04)
